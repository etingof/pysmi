...
relaxedGrammar = {
    ...
    'commaAtTheEndOfImport': [ p_importIdentifiers ],
    'commaAtTheEndOfSequence': [ p_sequenceItems ],
    'mixOfCommasAndSpaces': [ p_enumItems ],
    'uppercaseIdentifier': [ p_enumItem ],
    'lowcaseIdentifier': [ p_notificationTypeClause ],
    'curlyBracesAroundEnterpriseInTrap': [ p_trapTypeClause, p_EnterprisePart ],
    'noCells': [ p_CreationPart ]
}
